...
## SAN diagnostics
    ...
    if cube.attributes['STASH'] == 'm01s50i042':
        cube.rename(name='reaction_tendency_NO3_C5H8_in_moles_per_gridbox_per_sec')

    if cube.attributes['STASH'] == 'm01s50i147':
        cube.rename(name='reaction_tendency_OH_Monoterpene_in_moles_per_gridbox_per_sec')

    if cube.attributes['STASH'] == 'm01s50i148':
        cube.rename(name='reaction_tendency_O3_Monoterpene_in_moles_per_gridbox_per_sec')

    if cube.attributes['STASH'] == 'm01s50i149':
        cube.rename(name='reaction_tendency_NO3_Monoterpene_in_moles_per_gridbox_per_sec')

    if cube.attributes['STASH'] == 'm01s50i261':
        cube.rename(name='reaction_tendency_OH_C5H8_in_moles_per_gridbox_per_sec')

    if cube.attributes['STASH'] == 'm01s50i262':
        cube.rename(name='reaction_tendency_OH_C5H8_in_moles_per_gridbox_per_sec')
